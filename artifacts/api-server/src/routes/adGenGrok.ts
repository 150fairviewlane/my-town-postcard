...
function buildFooterZone(
  ...
  const qrZone =
    ...
    `Fill with footer bar's background color — solid, no patterns, no text, no marks, no barcodes, no symbols of any kind. ` +
...
router.post("/grok-ad-generator/generate", async (req, res): Promise<void> => {
      ...
      templateKey === "made-fresh"
        ...
        : templateKey === "neighborhood-pro"
          ? "  • IMAGE 1 (TEMPLATE) — a bold outdoor-service postcard layout on a deep forest-green background. " +
            ...
            "Footer strip: dark green bar with a bold phone number on the left, a solid magenta SCAN_BLOCK (post-processing marker) on the right, and three small circular decorative icon graphics between them. " +
          ...
          : templateKey === "at-your-service"
            ? "  • IMAGE 1 (TEMPLATE) — a home-services postcard on a light gray/off-white textured background with a navy blue and gold/yellow color scheme. " +
              ...
              "Footer: dark strip with a circular phone icon on the left and a solid magenta SCAN_BLOCK (post-processing marker) on the right. " +
            ...
            : templateKey === "home-elegance"
              ? "  • IMAGE 1 (TEMPLATE) — a premium home-services postcard on a cream/off-white background with dark navy blue and gold accents. " +
                ...
                "Footer: dark navy strip — phone icon + phone left, address icon + field center-left, solid magenta SCAN_BLOCK (post-processing marker) right. " +
              ...
              ? "  • IMAGE 1 (TEMPLATE) — a botanical organic postcard on a cream/beige textured background with dark olive/sage green and kraft paper accents. " +
                ...
                "Footer: dark olive green strip — location pin icon + address field left, solid magenta SCAN_BLOCK (post-processing marker) right. " +
              ...
              ? "  • IMAGE 1 (TEMPLATE) — a premium lifestyle/home-services postcard on a cream/beige background with muted lavender-purple and sage green accents. " +
                ...
                "Footer: dark purple strip — phone icon + oval pill field left, location pin icon + oval pill field center, solid magenta SCAN_BLOCK (post-processing marker) right. " +
              ...
              ? "  • IMAGE 1 (TEMPLATE) — a home-services postcard on a cream/parchment background with dark olive green and charcoal accents. " +
                ...
                "Footer: wide dark charcoal curved-top band spanning full width — circular phone icon + text field left, circular location pin + text field center, solid magenta SCAN_BLOCK (post-processing marker) right. " +
            ...
            : templateKey === "health-wellness"
              ? "  • IMAGE 1 (TEMPLATE) — a health and wellness postcard on a soft cream/off-white background with teal and sage green accents. " +
                ...
                "Lower-right corner: a small white rounded square — this is the solid magenta SCAN_BLOCK (post-processing marker) zone. " +
              ...
              ? "  • IMAGE 1 (TEMPLATE) — a dramatic dark restaurant/food postcard on a near-black background with deep red, gold, and parchment accents. " +
                ...
                "Footer: location pin icon + address pill left, phone icon + phone pill center-left, solid magenta SCAN_BLOCK (post-processing marker) right, gold arrow accent. " +
  ...
  const outputRequirements = isLandscape && templateKey === "parchment-classic"
    ? (
      ...
      (d.offer
        ? `  ZONE 5 — COUPON (dashed dark rectangular box, lower-right):\n` +
          ...
          "    NEVER place any scannable symbol, barcode, or patterned mark inside or adjacent to this coupon zone.\n\n"
        : "") +
    ...
    ? (
      ...
      (d.offer
        ? `  ZONE 5 — SPECIAL OFFER (visually distinct zone — a white rounded-rect or lightly outlined box, separate from service columns):\n` +
          ...
          (d.offerFine ? `    Fine print: "${d.offerFine}" smaller below.\n` : "") +
          "    NEVER place any scannable symbol, barcode, or patterned mark inside or adjacent to this offer zone.\n\n"
        : "") +
    ...
    ? (
      ...
      "  FOOTER: Phone number left, address below phone, solid magenta SCAN_BLOCK (post-processing marker) right.\n\n" +
      "QUALITY RULES:\n" +
...
var INDUSTRY_TEMPLATES = {
  ...
  'Liquor Store':                ['heritage-home','home-elegance','purple-sage','parchment-classic','brush-stroke','neighborhood-pro'],
  'Vape & Smoke Shop':           ['neighborhood-pro','brush-stroke','purple-sage','at-your-service','parchment-classic','home-elegance'],
  'Cell Phone Sales & Repair':   ['at-your-service','neighborhood-pro','health-wellness','home-elegance','parchment-classic','purple-sage'],
  'Toy Store':                   ['sage-organic','made-fresh','home-elegance','purple-sage','parchment-classic','neighborhood-pro'],
  'Jewelry Store':               ['heritage-home','home-elegance','purple-sage','parchment-classic','sage-organic','brush-stroke'],
  'Furniture Store':             ['home-elegance','heritage-home','sage-organic','parchment-classic','purple-sage','neighborhood-pro'],
  'Pawn Shop':                   ['at-your-service','neighborhood-pro','brush-stroke','home-elegance','parchment-classic','purple-sage'],
  'Thrift & Consignment':        ['sage-organic','made-fresh','parchment-classic','purple-sage','home-elegance','neighborhood-pro'],
  'Florist':                     ['sage-organic','heritage-home','home-elegance','purple-sage','parchment-classic','made-fresh'],
  'Garden Center & Nursery':     ['sage-organic','neighborhood-pro','made-fresh','parchment-classic','home-elegance','purple-sage'],
  'Sporting Goods':              ['neighborhood-pro','at-your-service','brush-stroke','parchment-classic','home-elegance','purple-sage'],
  'Bike Shop':                   ['neighborhood-pro','at-your-service','brush-stroke','sage-organic','parchment-classic','made-fresh'],
  'Gift Shop':                   ['sage-organic','made-fresh','home-elegance','purple-sage','parchment-classic','heritage-home'],
  'Bookstore':                   ['heritage-home','sage-organic','home-elegance','parchment-classic','purple-sage','made-fresh'],
  'Hardware Store':              ['neighborhood-pro','at-your-service','brush-stroke','parchment-classic','home-elegance','heritage-home'],
  'Tire Shop':                   ['at-your-service','neighborhood-pro','home-elegance','heritage-home','parchment-classic','purple-sage'],
  'Oil Change & Quick Lube':     ['at-your-service','neighborhood-pro','brush-stroke','parchment-classic','home-elegance','purple-sage'],
  'Car Wash & Detailing':        ['neighborhood-pro','sage-organic','brush-stroke','parchment-classic','home-elegance','purple-sage'],
  'Auto Body Shop':              ['at-your-service','neighborhood-pro','home-elegance','heritage-home','parchment-classic','purple-sage'],
  'Window Tinting':              ['neighborhood-pro','at-your-service','brush-stroke','home-elegance','purple-sage','parchment-classic'],
  'Event Venue':                 ['heritage-home','home-elegance','sage-organic','purple-sage','parchment-classic','made-fresh'],
  'Party & Equipment Rental':    ['neighborhood-pro','at-your-service','sage-organic','home-elegance','parchment-classic','purple-sage'],
  'DJ & Entertainment Services': ['neighborhood-pro','at-your-service','brush-stroke','home-elegance','purple-sage','parchment-classic'],
  'Law Firm':                    ['heritage-home','home-elegance','parchment-classic','purple-sage','neighborhood-pro','at-your-service'],
  'Accounting & Tax Prep':       ['at-your-service','home-elegance','heritage-home','parchment-classic','neighborhood-pro','purple-sage'],
  'Mortgage Broker':             ['home-elegance','heritage-home','sage-organic','parchment-classic','purple-sage','neighborhood-pro'],
  'Tutoring Services':           ['sage-organic','made-fresh','health-wellness','parchment-classic','home-elegance','purple-sage'],
  'Dance & Music Lessons':       ['sage-organic','made-fresh','home-elegance','purple-sage','parchment-classic','neighborhood-pro'],
  'Martial Arts Studio':         ['neighborhood-pro','at-your-service','brush-stroke','home-elegance','purple-sage','parchment-classic'],
  'Driving School':              ['at-your-service','neighborhood-pro','home-elegance','parchment-classic','purple-sage','sage-organic'],
  'BBQ Restaurant':              ['made-fresh','wok-fire','parchment-classic','neighborhood-pro','heritage-home','sage-organic'],
  'Sub & Sandwich Shop':         ['made-fresh','wok-fire','parchment-classic','neighborhood-pro','at-your-service','sage-organic'],
  'Ice Cream & Dessert Shop':    ['made-fresh','sage-organic','neighborhood-pro','parchment-classic','purple-sage','home-elegance'],
  'Food Truck & Catering':       ['made-fresh','wok-fire','neighborhood-pro','parchment-classic','sage-organic','at-your-service'],
};
...
var TAGLINE_DEFAULTS = {
  ...
  'Liquor Store':'Stocked & Ready for Any Occasion',
  'Vape & Smoke Shop':'Your Local Vape & Smoke Headquarters',
  'Cell Phone Sales & Repair':'Fast Repairs, Honest Prices',
  'Toy Store':'Where Playtime Begins',
  'Jewelry Store':'Timeless Pieces, Personal Service',
  'Furniture Store':'Quality Furniture for Every Room',
  'Pawn Shop':'Buy \u00b7 Sell \u00b7 Trade \u2014 Fair Deals Every Time',
  'Thrift & Consignment':'Great Finds, Great Prices',
  'Florist':'Fresh Flowers for Every Moment',
  'Garden Center & Nursery':'Grow Something Beautiful',
  'Sporting Goods':'Gear Up for Your Next Adventure',
  'Bike Shop':'Sales, Service & Repairs',
  'Gift Shop':'Find the Perfect Gift',
  'Bookstore':'Your Next Great Read Awaits',
  'Hardware Store':'Everything You Need, Right Down the Street',
  'Tire Shop':'New & Used Tires \u2014 All Sizes!',
  'Oil Change & Quick Lube':'In & Out \u2014 No Appointment Needed',
  'Car Wash & Detailing':'Shine Like New, Every Time',
  'Auto Body Shop':'Collision Repair Done Right',
  'Window Tinting':'Beat the Heat \u2014 Tint Today',
  'Event Venue':'The Perfect Setting for Your Special Day',
  'Party & Equipment Rental':'Everything You Need to Celebrate',
  'DJ & Entertainment Services':'Setting the Mood for Your Event',
  'Law Firm':'Experienced Legal Help When You Need It',
  'Accounting & Tax Prep':'Maximize Your Refund, Minimize Your Stress',
  'Mortgage Broker':'Your Path to Homeownership Starts Here',
  'Tutoring Services':'Helping Students Succeed, One Lesson at a Time',
  'Dance & Music Lessons':'Discover Your Passion for the Arts',
  'Martial Arts Studio':'Build Confidence, Discipline & Strength',
  'Driving School':'Confident Drivers Start Here',
  'BBQ Restaurant':'Slow-Smoked, Always Fresh',
  'Sub & Sandwich Shop':'Stacked Fresh, Made Your Way',
  'Ice Cream & Dessert Shop':'Sweet Treats for Every Occasion',
  'Food Truck & Catering':'Bringing the Flavor to You',
};
...
var OFFER_DEFAULTS = {
  ...
  'Liquor Store':                ['10% OFF Any Bottle $20+','With this postcard'],
  'Vape & Smoke Shop':           ['15% OFF First Purchase','New customers only \u00b7 with this postcard'],
  'Cell Phone Sales & Repair':   ['$10 OFF Screen Repair','With this postcard'],
  'Toy Store':                   ['FREE Gift Wrap with Purchase','With this postcard'],
  'Jewelry Store':               ['FREE Jewelry Cleaning','With this postcard'],
  'Furniture Store':             ['10% OFF Your First Purchase','With this postcard'],
  'Pawn Shop':                   ['Top Dollar for Gold & Electronics','Free, no-obligation quote'],
  'Thrift & Consignment':        ['20% OFF One Item','With this postcard'],
  'Florist':                     ['FREE Delivery on Orders $50+','With this postcard'],
  'Garden Center & Nursery':     ['10% OFF Any Plant Purchase','With this postcard'],
  'Sporting Goods':              ['10% OFF Your Purchase','With this postcard'],
  'Bike Shop':                   ['FREE Tune-Up with Bike Purchase','With this postcard'],
  'Gift Shop':                   ['10% OFF Your Purchase','With this postcard'],
  'Bookstore':                   ['Buy 2 Get 1 Free (Used Books)','With this postcard'],
  'Hardware Store':              ['10% OFF Any Purchase','With this postcard'],
  'Tire Shop':                   ['FREE Tire Rotation with Purchase','With this postcard'],
  'Oil Change & Quick Lube':     ['$10 OFF Full Synthetic Oil Change','With this postcard'],
  'Car Wash & Detailing':        ['FREE Vacuum with Any Wash','With this postcard'],
  'Auto Body Shop':              ['FREE Estimate \u2014 No Obligation','Call or text to schedule'],
  'Window Tinting':              ['$25 OFF Full Vehicle Tint','With this postcard'],
  'Event Venue':                 ['FREE Venue Tour & Consultation','Call or text to schedule'],
  'Party & Equipment Rental':    ['10% OFF Your First Rental','With this postcard'],
  'DJ & Entertainment Services': ['$50 OFF Booking','With this postcard'],
  'Law Firm':                    ['FREE Initial Consultation','Call or text to schedule'],
  'Accounting & Tax Prep':       ['$25 OFF Tax Preparation','New clients only \u00b7 with this postcard'],
  'Mortgage Broker':             ['FREE Rate Quote \u2014 No Obligation','Call or text to schedule'],
  'Tutoring Services':           ['FREE First Session','New students only \u00b7 with this postcard'],
  'Dance & Music Lessons':       ['FREE Trial Class','New students only \u00b7 call to schedule'],
  'Martial Arts Studio':         ['FREE Trial Class','New students only \u00b7 call to schedule'],
  'Driving School':              ['$25 OFF Driving Course','With this postcard'],
  'BBQ Restaurant':              ['FREE Side with Any Entr\u00e9e','One per visit \u00b7 with this postcard'],
  'Sub & Sandwich Shop':         ['BOGO \u2014 Buy One Sub, Get One 50% Off','One per order \u00b7 with this postcard'],
  'Ice Cream & Dessert Shop':    ['FREE Topping with Any Purchase','With this postcard'],
  'Food Truck & Catering':       ['10% OFF Your Catering Order','With this postcard'],
};
...
var MENU_DEFAULTS = {
  ...
  'Liquor Store':                ['Wine Selection','Craft Beer','Spirits & Liquor','Special Orders Available'],
  'Vape & Smoke Shop':           ['Vape Devices & Mods','E-Liquids & Juice','CBD Products','Accessories & Coils'],
  'Cell Phone Sales & Repair':   ['Screen Repair from $49','Battery Replacement','Unlocked Phones','Accessories'],
  'Toy Store':                   ['Educational Toys','Board Games','Action Figures','LEGO & Building Sets'],
  'Jewelry Store':               ['Rings & Bands','Necklaces & Pendants','Earrings','Custom Designs Available'],
  'Furniture Store':             ['Living Room','Bedroom Sets','Dining Room','Patio & Outdoor'],
  'Pawn Shop':                   ['Buy Gold & Jewelry','Electronics & Gaming','Guitars & Instruments','Free Appraisals'],
  'Thrift & Consignment':        ['Clothing & Accessories','Furniture & Decor','Electronics','Collectibles & Antiques'],
  'Florist':                     ['Fresh Bouquets from $35','Wedding Florals','Sympathy Arrangements','Custom Orders Welcome'],
  'Garden Center & Nursery':     ['Annual & Perennial Plants','Trees & Shrubs','Potting Soil & Mulch','Seasonal Decor'],
  'Sporting Goods':              ['Team Sports Equipment','Outdoor & Camping','Fitness & Weights','Footwear & Apparel'],
  'Bike Shop':                   ['Road Bikes','Mountain Bikes','Bike Repair & Tune-Up','Accessories & Parts'],
  'Gift Shop':                   ['Locally Made Gifts','Home Decor','Personalized Items','Gift Baskets'],
  'Bookstore':                   ['New Releases','Used Books from $1','Children\u2019s Books','Local Authors'],
  'Hardware Store':              ['Tools & Power Tools','Lumber & Building Materials','Paint & Supplies','Plumbing & Electrical'],
  'Tire Shop':                   ['New Tires \u2014 All Brands','Used Tires from $25','Tire Rotation & Balance','Flat Repair \u2014 Fast'],
  'Oil Change & Quick Lube':     ['Full Synthetic Oil Change','Conventional Oil Change','Filter Replacement','Multi-Point Inspection'],
  'Car Wash & Detailing':        ['Express Wash $10','Full Detail from $75','Interior Deep Clean','Wax & Polish'],
  'Auto Body Shop':              ['Collision Repair','Dent Removal','Paint Matching','Insurance Claims Welcome'],
  'Window Tinting':              ['Full Car Tint from $149','Ceramic Tint Upgrade','Truck & SUV Tint','Lifetime Warranty'],
  'Event Venue':                 ['Private Events & Weddings','Corporate Meetings','Birthday Parties','Full Catering Available'],
  'Party & Equipment Rental':    ['Tables & Chairs','Tents & Canopies','Bounce Houses','Sound & Lighting'],
  'DJ & Entertainment Services': ['Weddings & Receptions','Corporate Events','Birthday Parties','Karaoke Available'],
  'Law Firm':                    ['Personal Injury','Family Law','Estate Planning','Business Law'],
  'Accounting & Tax Prep':       ['Personal Tax Returns','Business Tax Filing','Bookkeeping Services','Payroll Services'],
  'Mortgage Broker':             ['Purchase Loans','Refinancing','First-Time Buyer Programs','Free Pre-Approval'],
  'Tutoring Services':           ['Math & Science','Reading & Writing','Test Prep (SAT/ACT)','All Grade Levels'],
  'Dance & Music Lessons':       ['Piano & Guitar','Dance Classes','Voice Lessons','After-School Programs'],
  'Martial Arts Studio':         ['Kids Karate Classes','Adult Self-Defense','Brazilian Jiu-Jitsu','Competition Training'],
  'Driving School':              ['Teen Driver Course','Adult Refresher','Defensive Driving','Behind-the-Wheel Training'],
  'BBQ Restaurant':              ['Pulled Pork Plate $12.99','Brisket Sandwich $11.99','Baby Back Ribs $18.99','Smoked Chicken $13.99'],
  'Sub & Sandwich Shop':         ['Classic Italian $9.99','Turkey Club $8.99','Meatball Sub $8.99','Veggie Sub $7.99'],
  'Ice Cream & Dessert Shop':    ['Soft Serve from $3.99','Sundaes from $5.99','Milkshakes from $6.99','Ice Cream Cakes'],
  'Food Truck & Catering':       ['Daily Specials \u2014 Follow Us!','Catering for 10\u2013500 Guests','Private Events','Corporate Lunches'],
};
...
function onIndustryChange(){
  ...
  var _isel = document.getElementById('industry');
  if(industry && _isel.size > 1){ _isel.size = 1; _isel.onblur = null; }
...
function onCategoryChange(){
  ...
  if(!industries.length){
    ...
    sel.focus();
    sel.onblur = function(){ sel.size = 1; sel.onblur = null; };
  }
  onIndustryChange();
