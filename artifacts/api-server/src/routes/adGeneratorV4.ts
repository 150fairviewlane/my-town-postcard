...
/* ── TEMPLATE 1: RUSTIC ── */
.tpl-rustic .ad-bg{filter:brightness(.7) saturate(1.1)}
.tpl-rustic .ad-overlay{position:absolute;inset:0;z-index:1;background:linear-gradient(160deg,rgba(30,15,5,.55) 0%,rgba(10,5,2,.2) 40%,rgba(10,5,2,.7) 100%)}
.tpl-rustic .ad-brush{position:absolute;bottom:0;left:0;right:0;height:55%;z-index:2;background:linear-gradient(to top,rgba(15,8,3,.97) 0%,rgba(15,8,3,.9) 40%,transparent 100%)}
.tpl-rustic .ad-badge{position:absolute;top:18px;left:18px;z-index:10;background:rgba(180,90,20,.9);border:2px solid rgba(255,200,100,.4);border-radius:4px;padding:6px 12px;font-family:'Oswald',sans-serif;font-size:11px;font-weight:600;letter-spacing:.15em;text-transform:uppercase;color:#FFE4B0}
.tpl-rustic .ad-content{position:absolute;inset:0;z-index:10;display:flex;flex-direction:column;justify-content:flex-end;padding:22px 20px 18px}
.tpl-rustic .ad-name{font-family:'Playfair Display',serif;font-weight:900;font-size:clamp(28px,6vw,48px);color:#fff;line-height:.95;letter-spacing:-.01em;text-shadow:2px 3px 12px rgba(0,0,0,.7)}
.tpl-rustic .ad-name .accent{color:#FFB347;font-style:italic;display:block;font-size:1.15em}
.tpl-rustic .ad-tagline{font-family:'Dancing Script',cursive;font-size:clamp(14px,3vw,20px);color:rgba(255,220,160,.9);margin-top:4px;margin-bottom:10px}
.tpl-rustic .ad-divider{width:50px;height:2px;background:linear-gradient(90deg,#FFB347,transparent);margin-bottom:10px;border-radius:2px}
.tpl-rustic .ad-menu{display:flex;flex-direction:column;gap:4px;margin-bottom:12px}
.tpl-rustic .ad-menu-item{display:flex;align-items:center;gap:7px;font-family:'DM Sans',sans-serif;font-size:clamp(11px,2.2vw,14px);color:rgba(255,255,255,.88);font-weight:500}
.tpl-rustic .ad-menu-item::before{content:'✦';color:#FFB347;font-size:8px;flex-shrink:0}
.tpl-rustic .ad-coupon{border:2px dashed rgba(255,180,80,.5);border-radius:6px;padding:7px 12px;margin-bottom:12px;background:rgba(0,0,0,.3);display:inline-block}
.tpl-rustic .ad-coupon-text{font-family:'Oswald',sans-serif;font-size:clamp(14px,2.8vw,20px);font-weight:700;color:#FFB347;letter-spacing:.06em;text-transform:uppercase}
.tpl-rustic .ad-coupon-fine{font-size:9px;color:rgba(255,255,255,.5);margin-top:1px;font-family:'DM Sans',sans-serif}
.tpl-rustic .ad-footer{display:flex;align-items:flex-end;justify-content:space-between;border-top:1px solid rgba(255,180,80,.2);padding-top:10px}
.tpl-rustic .ad-phone{font-family:'Bebas Neue',sans-serif;font-size:clamp(20px,4vw,30px);letter-spacing:.06em;color:#fff;line-height:1;text-shadow:0 2px 8px rgba(0,0,0,.6)}
.tpl-rustic .ad-address{font-size:clamp(9px,1.8vw,11px);color:rgba(255,255,255,.5);margin-top:2px;font-family:'DM Sans',sans-serif}
.tpl-rustic .ad-qr{display:flex;flex-direction:column;align-items:center;gap:3px}
.tpl-rustic .ad-qr-box{width:44px;height:44px;background:#fff;border-radius:4px;padding:3px}
.tpl-rustic .ad-qr-label{font-size:8px;color:rgba(255,255,255,.35);letter-spacing:.1em;text-transform:uppercase;font-family:'DM Sans',sans-serif}

/* ── TEMPLATE 2: DARK CINEMATIC ── */
.tpl-dark .ad-bg{filter:brightness(.5) saturate(.8)}
.tpl-dark .ad-overlay{position:absolute;inset:0;z-index:1;background:radial-gradient(ellipse at 70% 30%,rgba(120,20,30,.6) 0%,rgba(0,0,0,.1) 60%),linear-gradient(to bottom,rgba(0,0,0,.3) 0%,rgba(0,0,0,.95) 100%)}
.tpl-dark .ad-content{position:absolute;inset:0;z-index:10;display:flex;flex-direction:column;justify-content:flex-end;padding:24px 22px 20px}
.tpl-dark .ad-name{font-family:'Bebas Neue',sans-serif;font-size:clamp(36px,7vw,58px);letter-spacing:.04em;color:#fff;line-height:.9;text-shadow:0 4px 20px rgba(0,0,0,.5)}
.tpl-dark .ad-name .accent{color:#FF4444;display:block}
.tpl-dark .ad-tagline{font-family:'DM Sans',sans-serif;font-size:clamp(10px,2vw,13px);font-weight:500;letter-spacing:.18em;text-transform:uppercase;color:rgba(255,255,255,.55);margin-top:6px;margin-bottom:14px}
.tpl-dark .ad-menu{display:flex;flex-direction:column;gap:3px;margin-bottom:12px}
.tpl-dark .ad-menu-item{display:flex;align-items:center;gap:8px;font-family:'DM Sans',sans-serif;font-size:clamp(11px,2.2vw,13px);color:rgba(255,255,255,.75);font-weight:400}
.tpl-dark .ad-menu-dot{width:4px;height:4px;border-radius:50%;background:#FF4444;flex-shrink:0}
.tpl-dark .ad-coupon{background:rgba(255,255,255,.06);border:1px solid rgba(255,255,255,.15);border-radius:6px;padding:8px 14px;margin-bottom:14px;display:inline-block}
.tpl-dark .ad-coupon-text{font-family:'Bebas Neue',sans-serif;font-size:clamp(18px,3.5vw,26px);letter-spacing:.06em;color:#fff}
.tpl-dark .ad-coupon-text span{color:#FF4444}
.tpl-dark .ad-coupon-fine{font-size:9px;color:rgba(255,255,255,.4);margin-top:1px}
.tpl-dark .ad-footer{display:flex;align-items:flex-end;justify-content:space-between;border-top:1px solid rgba(255,255,255,.1);padding-top:10px}
.tpl-dark .ad-phone{font-family:'Bebas Neue',sans-serif;font-size:clamp(22px,4.5vw,32px);letter-spacing:.06em;color:#fff;line-height:1}
.tpl-dark .ad-address{font-size:clamp(9px,1.8vw,11px);color:rgba(255,255,255,.4);margin-top:2px}
.tpl-dark .ad-qr .ad-qr-box{width:44px;height:44px;background:#fff;border-radius:4px;padding:3px}
.tpl-dark .ad-qr{display:flex;flex-direction:column;align-items:center;gap:3px}
.tpl-dark .ad-qr-label{font-size:8px;color:rgba(255,255,255,.3);letter-spacing:.1em;text-transform:uppercase}

/* ── TEMPLATE 3: BOLD SPLIT ── */
.tpl-bold .ad-bg{filter:brightness(.65) saturate(1.2)}
.tpl-bold .ad-overlay{position:absolute;inset:0;z-index:1;background:linear-gradient(105deg,rgba(10,10,20,.95) 0%,rgba(10,10,20,.9) 42%,transparent 43%)}
.tpl-bold .ad-accent-bar{position:absolute;top:0;left:320px;width:6px;height:100%;background:var(--accent-color,#E63946);z-index:5;transform:skewX(-3deg)}
.tpl-bold .ad-content{position:absolute;inset:0;z-index:10;display:flex;flex-direction:column;justify-content:center;padding:24px 22px}
.tpl-bold .ad-name{font-family:'Bebas Neue',sans-serif;font-size:clamp(32px,6.5vw,52px);letter-spacing:.03em;color:#fff;line-height:.9;max-width:280px}
.tpl-bold .ad-name .accent{color:var(--accent-color,#E63946);display:block;font-size:1.1em}
.tpl-bold .ad-tagline{font-family:'DM Sans',sans-serif;font-size:clamp(9px,1.8vw,12px);font-weight:600;letter-spacing:.2em;text-transform:uppercase;color:rgba(255,255,255,.5);margin-top:8px;margin-bottom:16px;max-width:260px}
.tpl-bold .ad-menu{display:flex;flex-direction:column;gap:5px;margin-bottom:14px;max-width:260px}
.tpl-bold .ad-menu-item{display:flex;align-items:center;gap:8px;font-family:'DM Sans',sans-serif;font-size:clamp(11px,2.2vw,13px);color:rgba(255,255,255,.8);font-weight:500}
.tpl-bold .ad-check{width:16px;height:16px;background:var(--accent-color,#E63946);border-radius:3px;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:9px;color:#fff;font-weight:700}
.tpl-bold .ad-coupon{border:2px dashed rgba(255,255,255,.3);border-radius:6px;padding:8px 12px;margin-bottom:16px;display:inline-block;max-width:260px}
.tpl-bold .ad-coupon-text{font-family:'Bebas Neue',sans-serif;font-size:clamp(16px,3.2vw,24px);letter-spacing:.04em;color:#fff}
.tpl-bold .ad-coupon-text span{color:var(--accent-color,#E63946)}
.tpl-bold .ad-coupon-fine{font-size:9px;color:rgba(255,255,255,.4);margin-top:1px}
.tpl-bold .ad-footer{display:flex;align-items:flex-end;justify-content:space-between;border-top:1px solid rgba(255,255,255,.12);padding-top:10px;max-width:260px}
...
.tpl-bold .ad-address{font-size:clamp(9px,1.8vw,10px);color:rgba(255,255,255,.4);margin-top:2px}
.tpl-bold .ad-qr{display:flex;flex-direction:column;align-items:center;gap:3px}
.tpl-bold .ad-qr-box{width:40px;height:40px;background:#fff;border-radius:4px;padding:3px}
.tpl-bold .ad-qr-label{font-size:8px;color:rgba(255,255,255,.3);letter-spacing:.1em;text-transform:uppercase}

/* ── TEMPLATE 4: LUXURY ── */
.tpl-luxury .ad-bg{filter:brightness(.45) saturate(.7)}
.tpl-luxury .ad-overlay{position:absolute;inset:0;z-index:1;background:linear-gradient(to bottom,rgba(10,8,5,.4) 0%,rgba(5,4,2,.85) 100%)}
.tpl-luxury .ad-frame{position:absolute;inset:12px;z-index:2;border:1px solid rgba(200,160,60,.3);pointer-events:none}
.tpl-luxury .ad-frame-inner{position:absolute;inset:18px;z-index:2;border:0.5px solid rgba(200,160,60,.15);pointer-events:none}
.tpl-luxury .ad-content{position:absolute;inset:0;z-index:10;display:flex;flex-direction:column;align-items:center;justify-content:flex-end;padding:28px 26px 22px;text-align:center}
.tpl-luxury .ad-ornament{font-size:12px;letter-spacing:.4em;color:rgba(200,160,60,.7);margin-bottom:8px}
.tpl-luxury .ad-name{font-family:'Playfair Display',serif;font-weight:700;font-size:clamp(24px,5vw,40px);color:#fff;letter-spacing:.04em;line-height:1.05;text-shadow:0 2px 12px rgba(0,0,0,.5)}
.tpl-luxury .ad-tagline{font-family:'Crimson Pro',serif;font-style:italic;font-size:clamp(12px,2.5vw,17px);color:rgba(200,160,60,.85);margin-top:6px;margin-bottom:10px}
.tpl-luxury .ad-rule{width:60px;height:1px;background:linear-gradient(90deg,transparent,rgba(200,160,60,.7),transparent);margin:0 auto 12px}
.tpl-luxury .ad-menu{display:flex;flex-direction:column;gap:4px;margin-bottom:10px;width:100%}
.tpl-luxury .ad-menu-item{font-family:'DM Sans',sans-serif;font-size:clamp(10px,2vw,12.5px);color:rgba(255,255,255,.7);font-weight:400;letter-spacing:.04em;text-align:center}
.tpl-luxury .ad-coupon{border:1px solid rgba(200,160,60,.4);border-radius:3px;padding:7px 16px;margin-bottom:12px;display:inline-block;background:rgba(200,160,60,.07)}
.tpl-luxury .ad-coupon-text{font-family:'Playfair Display',serif;font-size:clamp(14px,2.8vw,20px);color:#fff;letter-spacing:.04em}
.tpl-luxury .ad-coupon-fine{font-size:9px;color:rgba(255,255,255,.4);margin-top:2px}
.tpl-luxury .ad-footer{display:flex;align-items:flex-end;justify-content:space-between;border-top:1px solid rgba(200,160,60,.2);padding-top:10px;width:100%}
.tpl-luxury .ad-phone{font-family:'Playfair Display',serif;font-size:clamp(16px,3.2vw,24px);color:rgba(200,160,60,.9);line-height:1;letter-spacing:.04em}
.tpl-luxury .ad-address{font-size:clamp(9px,1.8vw,10.5px);color:rgba(255,255,255,.4);margin-top:2px}
.tpl-luxury .ad-qr{display:flex;flex-direction:column;align-items:center;gap:3px}
.tpl-luxury .ad-qr-box{width:44px;height:44px;background:#fff;border-radius:3px;padding:3px}
.tpl-luxury .ad-qr-label{font-size:8px;color:rgba(200,160,60,.4);letter-spacing:.1em;text-transform:uppercase}

/* ── TEMPLATE 5: BRIGHT & BOLD ── */
.tpl-bright .ad-bg{filter:brightness(.55) saturate(1.3)}
.tpl-bright .ad-overlay{position:absolute;inset:0;z-index:1;background:linear-gradient(to bottom,rgba(255,255,255,.0) 0%,rgba(0,0,0,.85) 100%)}
.tpl-bright .ad-top-band{position:absolute;top:0;left:0;right:0;height:80px;z-index:5;background:var(--accent-color,#FF6B35);clip-path:polygon(0 0,100% 0,100% 70%,0 100%)}
.tpl-bright .ad-top-name{position:absolute;top:12px;left:18px;right:18px;z-index:10;font-family:'Bebas Neue',sans-serif;font-size:clamp(28px,5.5vw,44px);letter-spacing:.04em;color:#fff;line-height:1;text-shadow:1px 2px 6px rgba(0,0,0,.3)}
.tpl-bright .ad-content{position:absolute;inset:0;z-index:10;display:flex;flex-direction:column;justify-content:flex-end;padding:20px 18px 16px}
.tpl-bright .ad-name{display:none}
.tpl-bright .ad-tagline{font-family:'DM Sans',sans-serif;font-size:clamp(10px,2vw,13px);font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:rgba(255,255,255,.7);margin-bottom:10px}
.tpl-bright .ad-menu{display:flex;flex-direction:column;gap:4px;margin-bottom:10px}
.tpl-bright .ad-menu-item{display:flex;align-items:center;gap:7px;font-family:'DM Sans',sans-serif;font-size:clamp(11px,2.2vw,13.5px);color:#fff;font-weight:600}
.tpl-bright .ad-menu-bullet{width:18px;height:18px;border-radius:50%;background:var(--accent-color,#FF6B35);display:flex;align-items:center;justify-content:center;font-size:9px;color:#fff;font-weight:700;flex-shrink:0}
.tpl-bright .ad-coupon{background:var(--accent-color,#FF6B35);border-radius:6px;padding:8px 14px;margin-bottom:12px;display:inline-block}
.tpl-bright .ad-coupon-text{font-family:'Bebas Neue',sans-serif;font-size:clamp(16px,3.2vw,24px);letter-spacing:.06em;color:#fff}
.tpl-bright .ad-coupon-fine{font-size:9px;color:rgba(255,255,255,.7);margin-top:1px}
.tpl-bright .ad-footer{display:flex;align-items:flex-end;justify-content:space-between;border-top:1px solid rgba(255,255,255,.15);padding-top:10px}
.tpl-bright .ad-phone{font-family:'Bebas Neue',sans-serif;font-size:clamp(20px,4vw,30px);letter-spacing:.06em;color:#fff;line-height:1}
.tpl-bright .ad-address{font-size:clamp(9px,1.8vw,10.5px);color:rgba(255,255,255,.5);margin-top:2px}
.tpl-bright .ad-qr{display:flex;flex-direction:column;align-items:center;gap:3px}
.tpl-bright .ad-qr-box{width:44px;height:44px;background:#fff;border-radius:4px;padding:3px}
.tpl-bright .ad-qr-label{font-size:8px;color:rgba(255,255,255,.35);letter-spacing:.1em;text-transform:uppercase}

/* ── TEMPLATE 6: CLEAN EDITORIAL ── */
.tpl-clean .ad-bg{filter:brightness(.4) saturate(.6)}
.tpl-clean .ad-overlay{position:absolute;inset:0;z-index:1;background:linear-gradient(160deg,rgba(255,255,255,.92) 0%,rgba(255,255,255,.88) 45%,rgba(0,0,0,.6) 100%)}
.tpl-clean .ad-content{position:absolute;inset:0;z-index:10;display:flex;flex-direction:column;justify-content:space-between;padding:24px 22px 20px}
.tpl-clean .ad-top{border-left:4px solid var(--ink);padding-left:12px;margin-bottom:0}
.tpl-clean .ad-name{font-family:'Playfair Display',serif;font-weight:900;font-size:clamp(22px,4.5vw,36px);color:var(--ink);line-height:1;letter-spacing:-.01em}
.tpl-clean .ad-name .accent{color:var(--accent-color,#1B3A6B);font-style:italic}
.tpl-clean .ad-tagline{font-family:'DM Sans',sans-serif;font-size:clamp(9px,1.8vw,11px);font-weight:600;letter-spacing:.16em;text-transform:uppercase;color:var(--ink-light);margin-top:5px}
.tpl-clean .ad-middle{flex:1;display:flex;flex-direction:column;justify-content:center;padding:16px 0}
.tpl-clean .ad-menu{display:flex;flex-direction:column;gap:6px;margin-bottom:12px}
.tpl-clean .ad-menu-item{display:flex;align-items:center;justify-content:space-between;font-family:'DM Sans',sans-serif;font-size:clamp(11px,2.2vw,13px);color:var(--ink-mid);font-weight:500;padding-bottom:5px;border-bottom:1px solid rgba(0,0,0,.08)}
.tpl-clean .ad-coupon{background:var(--ink);border-radius:5px;padding:8px 14px;margin-top:4px;display:inline-block}
.tpl-clean .ad-coupon-text{font-family:'Bebas Neue',sans-serif;font-size:clamp(16px,3.2vw,22px);letter-spacing:.06em;color:#fff}
.tpl-clean .ad-coupon-fine{font-size:9px;color:rgba(255,255,255,.55);margin-top:1px}
.tpl-clean .ad-footer{display:flex;align-items:flex-end;justify-content:space-between;border-top:2px solid var(--ink);padding-top:10px}
.tpl-clean .ad-phone{font-family:'Bebas Neue',sans-serif;font-size:clamp(20px,4vw,30px);letter-spacing:.04em;color:var(--ink);line-height:1}
.tpl-clean .ad-address{font-size:clamp(9px,1.8vw,11px);color:var(--ink-light);margin-top:2px}
.tpl-clean .ad-qr{display:flex;flex-direction:column;align-items:center;gap:3px}
.tpl-clean .ad-qr-box{width:44px;height:44px;background:var(--ink);border-radius:4px;padding:4px}
.tpl-clean .ad-qr-label{font-size:8px;color:var(--ink-light);letter-spacing:.1em;text-transform:uppercase}
    ...
    <div class="fsec">
      ...
      <div class="style-grid">
        ...
        <div class="scard">
          ...
          <label for="s-bold"><div class="swatch" style="background:linear-gradient(135deg,#1a1a2e 50%,#E63946 50%)"></div><div class="sinfo"><div class="sname">Bold &amp; Split</div><div class="sdesc">Geometric, high impact</div></div></label>
          <div class="selbadge">✓</div>
        </div>
        <div class="scard">
        ...
        <div class="scard">
          ...
          <label for="s-bright"><div class="swatch" style="background:linear-gradient(135deg,#FF6B35,#FFF0F3)"></div><div class="sinfo"><div class="sname">Bright &amp; Bold</div><div class="sdesc">Colorful, energetic, fun</div></div></label>
          <div class="selbadge">✓</div>
        </div>
        <div class="scard">
          <input type="radio" name="style" id="s-clean" value="clean" onchange="renderAd()">
          <label for="s-clean"><div class="swatch" style="background:#fff;border:1.5px solid #ddd"></div><div class="sinfo"><div class="sname">Clean &amp; Editorial</div><div class="sdesc">Simple, professional</div></div></label>
          <div class="selbadge">✓</div>
        </div>
      </div>
    </div>
...
// ── MENU HTML HELPER ──────────────────────────────────────────
function menuItemsHTML(d, tplClass){
  return d.menu.slice(0,4).map(item => {
    if(tplClass==='tpl-rustic') return \`<div class="ad-menu-item">\${item}</div>\`;
    if(tplClass==='tpl-dark')   return \`<div class="ad-menu-item"><div class="ad-menu-dot"></div>\${item}</div>\`;
    if(tplClass==='tpl-bold')   return \`<div class="ad-menu-item"><div class="ad-check">✓</div>\${item}</div>\`;
    if(tplClass==='tpl-luxury') return \`<div class="ad-menu-item">\${item}</div>\`;
    if(tplClass==='tpl-bright') return \`<div class="ad-menu-item"><div class="ad-menu-bullet">✓</div>\${item}</div>\`;
    if(tplClass==='tpl-clean')  return \`<div class="ad-menu-item"><span>\${item}</span></div>\`;
    return \`<div class="ad-menu-item">\${item}</div>\`;
  }).join('');
}

// ── COUPON HTML HELPER ────────────────────────────────────────
function couponHTML(d, tplClass){
  if(!d.offer) return '';
  const parts = d.offer.split('·');
  const main = parts[0].trim();
  const fine = parts[1] ? parts[1].trim() : '1 per visit · with this postcard';

  if(tplClass==='tpl-dark'){
    const m = main.match(/^(\\$[\\d.]+)\\s+(.+)$/);
    if(m) return \`<div class="ad-coupon"><div class="ad-coupon-text"><span>\${m[1]}</span> \${m[2]}</div><div class="ad-coupon-fine">\${fine}</div></div>\`;
  }
  if(tplClass==='tpl-bold'){
    const m = main.match(/^(\\$[\\d.]+)\\s+(.+)$/);
    if(m) return \`<div class="ad-coupon"><div class="ad-coupon-text"><span>\${m[1]}</span> \${m[2]}</div><div class="ad-coupon-fine">\${fine}</div></div>\`;
  }
  return \`<div class="ad-coupon"><div class="ad-coupon-text">\${main}</div><div class="ad-coupon-fine">\${fine}</div></div>\`;
}
...
function renderAd(){
  ...
  const tpl = d.style;
  const tplClass = \`tpl-\${tpl}\`;
  const bgStyle = d.photo ? \`background-image:url('\${d.photo}')\` : 'background:#333';

  const nameParts = d.bizName.split(' ');
  const nameMain = nameParts.length > 1 ? nameParts.slice(0,-1).join(' ') : d.bizName;
  const nameAccent = nameParts.length > 1 ? nameParts[nameParts.length-1] : '';

  const addrLine = [d.address, d.city].filter(Boolean).join(', ');
  ...
  if(tpl==='rustic'){
    html = \`
      <div class="\${tplClass}">
        ...
        \${d.tagline?\`<div class="ad-badge">\${d.tagline}</div>\`:''}
        <div class="ad-content">
          <div class="ad-name">\${nameMain}\${nameAccent?\`<span class="accent">\${nameAccent}</span>\`:''}</div>
          \${d.tagline?\`<div class="ad-tagline">\${d.tagline}</div>\`:''}
          <div class="ad-divider"></div>
          \${d.menu.length?\`<div class="ad-menu">\${menuItemsHTML(d,tplClass)}</div>\`:''}
          \${couponHTML(d,tplClass)}
          <div class="ad-footer">
            <div><div class="ad-phone">\${d.phone||'—'}</div><div class="ad-address">\${addrLine}</div></div>
            \${qrHTML()}
          </div>
        </div>
      </div>\`;
    ...
    html = \`
      <div class="\${tplClass}">
        ...
        <div class="ad-content">
          <div class="ad-name">\${nameMain}\${nameAccent?\`<span class="accent">\${nameAccent}</span>\`:''}</div>
          <div class="ad-tagline">\${d.tagline}</div>
          \${d.menu.length?\`<div class="ad-menu">\${menuItemsHTML(d,tplClass)}</div>\`:''}
          \${couponHTML(d,tplClass)}
          <div class="ad-footer">
            <div><div class="ad-phone">\${d.phone||'—'}</div><div class="ad-address">\${addrLine}</div></div>
    ...
    html = \`
      <div class="\${tplClass}" style="--accent-color:\${d.color}">
        <div class="ad-bg" style="\${bgStyle}"></div>
        <div class="ad-overlay"></div>
        <div class="ad-accent-bar"></div>
        <div class="ad-content">
          <div class="ad-name">\${nameMain}\${nameAccent?\`<span class="accent">\${nameAccent}</span>\`:''}</div>
          <div class="ad-tagline">\${d.tagline}</div>
          \${d.menu.length?\`<div class="ad-menu">\${menuItemsHTML(d,tplClass)}</div>\`:''}
    ...
    html = \`
      <div class="\${tplClass}" style="--accent-color:\${d.color}">
        <div class="ad-bg" style="\${bgStyle}"></div>
        <div class="ad-overlay"></div>
        <div class="ad-top-band"></div>
        <div class="ad-top-name">\${d.bizName}</div>
        <div class="ad-content">
          <div></div>
          <div>
            <div class="ad-tagline">\${d.tagline}</div>
