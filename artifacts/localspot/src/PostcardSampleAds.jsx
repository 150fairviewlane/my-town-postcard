...
const REF_ADS = {
  mrbiscuits: {
    ...
    phone: "(706) 754-0105", addr: "Northeast Georgia", web: "mrbiscuitscafe.com",
  ...
  roofing: {
    ...
    phone: "(770) 725-1010", addr: "Northeast Georgia", web: "pineridgeroofing.com",
  ...
  dental: {
    ...
    phone: "(770) 704-1633", addr: "Northeast Georgia", web: "northviewdental.com",
  ...
  lawn: {
    ...
    phone: "(706) 257-1186", addr: "Northeast Georgia", web: "greenscapeslawncare.com",
  ...
  hvac: {
    ...
    phone: "(770) 365-6599", addr: "Northeast Georgia", web: "climatecomforthvac.com",
  ...
  auto: {
    ...
    phone: "(706) 219-6136", addr: "Northeast Georgia", web: "",
  ...
  vet: {
    ...
    phone: "(770) 592-7387", addr: "Northeast Georgia", web: "pawsandclawsvet.com",
  ...
  pizza: {
    ...
    phone: "(706) 507-1111", addr: "Northeast Georgia", web: "tonyspizzaga.com",
  ...
  salon: {
    ...
    phone: "(706) 555-0519", addr: "Northeast Georgia", web: "",
...
export const SAMPLE_AD_CONFIGS = {
  "pizza": {
    ...
    data: {
      ...
      phone: "(706) 555-0712", address: "Northeast Georgia",
  ...
  "dental": {
    ...
    data: {
      businessName: "Valley Family Dental", industry: "Dentist",
      tagline: "Accepting New Patients!", starburst: "NEW!",
      offer: "FREE Whitening Kit", offerFine: "w/ exam & cleaning · show this ad",
      phone: "(706) 555-0142", address: "Northeast Georgia",
      website: "valleyfamilydental.com",
  ...
  "insurance": {
    ...
    data: {
      ...
      phone: "(706) 555-0388", address: "Northeast Georgia",
  ...
  "lawn": {
    ...
    data: {
      ...
      phone: "(706) 555-0291", address: "Northeast Georgia",
  ...
  "salon": {
    ...
    data: {
      ...
      phone: "(706) 555-0519", address: "Northeast Georgia",
  ...
  "autorepair": {
    ...
    data: {
      ...
      phone: "(770) 678-7890", address: "Northeast Georgia",
  ...
  "mexican": {
    ...
    data: {
      ...
      phone: "(706) 555-0644", address: "Northeast Georgia",
  ...
  "gym": {
    ...
    data: {
      ...
      phone: "(706) 555-0788", address: "Northeast Georgia",
  ...
  "vet": {
    ...
    data: {
      businessName: "Valley Animal Clinic", industry: "Veterinarian",
      tagline: "Compassionate Pet Care",
      offer: "Free First Exam", offerFine: "New patients · call to schedule",
      phone: "(706) 555-0322", address: "Northeast Georgia",
      website: "valleyanimalclinic.com",
      ...
      <div style={{ position: "relative", zIndex: 2, padding: `${5 * fScale}px ${10 * fScale}px ${8 * fScale}px`, display: "flex", flexDirection: "column", gap: 4 * fScale, flexShrink: 0 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", color: "#fff", fontFamily: "sans-serif", textShadow: "0 1px 4px rgba(0,0,0,0.7)", gap: 6 * fScale }}>
          <div style={{ display: "flex", flexDirection: "column", gap: 1, minWidth: 0, flex: 1 }}>
            {data.address && <div style={{ fontSize: 11 * fScale, fontWeight: 800 }}>📍 {data.address}</div>}
        ...
        <div style={{ flexShrink: 0 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 6 * fScale, marginBottom: data.offer ? 5 * fScale : 0 }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 2, minWidth: 0, flex: 1 }}>
              {data.address && <div style={{ fontSize: (isS ? 9.5 : 11) * fScale, color: "#222", fontWeight: 700 }}>📍 {data.address}</div>}
              {data.phone && (
                <div style={{
      ...
      <div style={{ flex: 1, padding: `${4 * fScale}px ${9 * fScale}px ${6 * fScale}px`, display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: 0, gap: 3 * fScale }}>
        ...
        <div style={{ flexShrink: 0, display: "flex", flexDirection: "column", gap: 3 * fScale }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", gap: 6 * fScale }}>
            <div style={{ display: "flex", flexDirection: "column", gap: 1, minWidth: 0, flex: 1 }}>
              {data.address && <div style={{ fontSize: (isS ? 9.5 : 11) * fScale, color: "#222", fontFamily: "sans-serif", fontWeight: 700 }}>📍 {data.address}</div>}
  ...
  return (
    <div style={{ width: "100%", height: "100%", overflow: "hidden", position: "relative", background: ind.colors.dark, fontFamily: "sans-serif" }}>
      ...
      <div style={{ position: "absolute", top: "28%", left: 0, right: 0, padding: `0 ${12 * fScale}px`, textAlign: "center", zIndex: 3 }}>
        ...
        {data.phone && !isS && (
          <div style={{ color: ind.colors.accent, fontWeight: 900, fontSize: (isXL ? 32 : isL ? 26 : 21) * fScale, lineHeight: 1.05, marginTop: 5 * fScale, letterSpacing: -0.5, textShadow: "0 2px 14px rgba(0,0,0,0.95)", whiteSpace: "nowrap" }}>
            {data.phone}
          </div>
        )}
        {!isS && (
      ...
      <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, padding: `${6 * fScale}px ${10 * fScale}px ${8 * fScale}px`, display: "flex", flexDirection: "column", gap: 4 * fScale, zIndex: 3 }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 6 * fScale }}>
          <div style={{ color: "#fff", fontSize: (isS ? 10 : 11.5) * fScale, fontWeight: 800, fontFamily: "sans-serif", display: "flex", flexDirection: "column", gap: 2, textShadow: "0 1px 4px rgba(0,0,0,0.85)", flex: 1, minWidth: 0 }}>
